...
<h3 align="center">Full Stack Developer · AI Integrations · SaaS Builder</h3>
...
- 📦 Shipped **2 live products** — from AI accounting platforms to CRM software
...
![Groq](https://img.shields.io/badge/Groq_AI-FF6B35?style=flat&logo=groq&logoColor=white)
...
|---|---|---|
| [**Inbocs**](https://inbocs.vercel.app/) | Email-to-WhatsApp AI digest — triages emails by priority and delivers a daily summary via WhatsApp | Next.js · Gemini AI · PostgreSQL · Twilio · Dodo Payments |
| [**Velocity Tools**](https://velocitytool.vercel.app/) | Conversational AI that gives developers curated tool guides and step-by-step build plans | Next.js · Groq AI · Tailwind CSS |
| [**AI Roadmap Generator**](https://ai-roadmap-g.vercel.app/) | Generates personalised learning roadmaps with curated resources based on your skill goals | MERN · Next.js · Gemini AI |
| [**Credit Card AI Finder**](https://creditcardai.netlify.app/) | Recommends the best credit card based on spending habits via natural language prompts | Next.js · Gemini AI |
| [**Confirt**](https://www.confirt.com/) | Client website + secure admin dashboard with JWT auth and full content management | Next.js · Express.js · MongoDB |
...
<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=gouravbht&theme=default" alt="gouravbht streak" />
</p>
